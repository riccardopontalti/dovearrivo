...
- **Trenitalia S.p.A.** — planned rail timetables via the Italian National Access Point. Licence to be confirmed from the primary source in D01; not used until then.
...
- **Protomaps** — planned basemap tiles derived from OpenStreetMap; record the licences of style, fonts and sprites actually used.
