...
- **Fraunces** (The Fraunces Project Authors) and **Inter** (The Inter Project Authors) — interface fonts under the [SIL Open Font License 1.1](https://openfontlicense.org), bundled from the `@fontsource-variable` packages and served by our server; licence texts ship with the site under `/licenses/`.
